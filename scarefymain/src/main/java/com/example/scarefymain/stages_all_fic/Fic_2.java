...
public class Fic_2 extends Activity {
    private static final String TAG = Fic_2.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _return.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent go = new Intent(Fic_2.this, Kat_Pages.class);
                startActivity(go);
                finish();
            }
        });
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    Fic_2.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
