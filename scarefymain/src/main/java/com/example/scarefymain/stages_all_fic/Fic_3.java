package com.example.scarefymain.stages_all_fic;
...
public class Fic_3 extends Activity {
    private static final String TAG = Fic_3.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _return.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent go = new Intent(Fic_3.this, Kat_Pages.class);
                startActivity(go);
                finish();
            }
        });
    ...
    class ImageLoaderTask extends AsyncTask<Pair<Uri, VrPanoramaView.Options>, Void, Boolean> {
        ...
        protected Boolean doInBackground(Pair<Uri, VrPanoramaView.Options>... fileInformation) {
            ...
            if (fileInformation == null || fileInformation.length < 1
                ...
                try {
                    istr = assetManager.open("parking1.jpg");
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    Fic_3.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
