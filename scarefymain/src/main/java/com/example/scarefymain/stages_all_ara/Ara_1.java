...
public class Ara_1 extends Activity {
    private static final String TAG = Ara_1.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _return.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent go = new Intent(Ara_1.this, Kat_Pages.class);
                startActivity(go);
                finish();
            }
        });
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    Ara_1.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
