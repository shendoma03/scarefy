package com.example.scarefymain.stages_all_ara;
...
public class Ara_2 extends Activity {
    private static final String TAG = Ara_2.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _return.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent go = new Intent(Ara_2.this, Kat_Pages.class);
                startActivity(go);
                finish();
            }
        });
    ...
    class ImageLoaderTask extends AsyncTask<Pair<Uri, VrPanoramaView.Options>, Void, Boolean> {
        ...
        protected Boolean doInBackground(Pair<Uri, VrPanoramaView.Options>... fileInformation) {
            ...
            if (fileInformation == null || fileInformation.length < 1
                ...
                try {
                    istr = assetManager.open("ara1.jpg");
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    Ara_2.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
