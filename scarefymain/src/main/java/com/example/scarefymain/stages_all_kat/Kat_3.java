package com.example.scarefymain.stages_all_kat;
...
public class Kat_3 extends Activity {
    private static final String TAG = Kat_1.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        _return.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent go = new Intent(Kat_3.this, Kat_Pages.class);
                startActivity(go);
                finish();
            }
        });
    ...
    class ImageLoaderTask extends AsyncTask<Pair<Uri, VrPanoramaView.Options>, Void, Boolean> {
        ...
        protected Boolean doInBackground(Pair<Uri, VrPanoramaView.Options>... fileInformation) {
            ...
            if (fileInformation == null || fileInformation.length < 1
                ...
                try {
                    istr = assetManager.open("kat3.jpg");
    ...
    private class ActivityEventListener extends VrPanoramaEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    Kat_3.this, "Error loading pano: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
